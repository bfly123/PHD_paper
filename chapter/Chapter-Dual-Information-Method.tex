...
我们引入一种新型粒子 --- {\bf{信息点}}，信息点上除携带有位置信息外还携带有对流的物理信息$z$。不同于PIC中的真实粒子，信息点可以看成是对所在物理场的一种映射。我们知道网格是对真实流场的一种映射，我们可以随时加密网格、减少网格甚至移动网格的位置，尽管这可能影响计算精度，但是并不会改变所研究问题本质。 类比与网格，信息点同样是流场在空间的映射，我们可以根据需要增加、减少和移动粒子点。
