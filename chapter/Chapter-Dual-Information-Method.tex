...
\setlength{\parskip}{0\baselineskip}
 ...
 \color{black!80}
  ...
  \hspace{0.2cm} $Np=Nx$  
	\hspace{2cm}  { \color{black!60} !$Np$为粒子点总数，会因为出流和入流变化}{ \color{black!80}}
 ...
 \color{black!80}
  ...
  $\left\{
	...
	\end{array}
\right. $
	\hspace{2cm}  { \color{black!60} !其中$N_p$为粒子点总数，会因为出流和入流变化}{ \color{black!80}}
 ...
 \hspace{-0.5cm}
  ...
  \scriptsize
   ...
   $\text{Mrk}(i)=0, \hspace{0.3cm}  \text{Mrk}_p(i)=0$ 
  \hspace{2cm} { \color{black!60} !用来标记第i单元中临时的单元点数量和粒子点数量} \color{black!80}
...
\scriptsize
 ...
 \hspace{0.3cm}
	$M(i)=i+floor(L_x+0.5)$
\hspace{2cm}   { \color{black!60} ! i单元点移动到$M$单元} {\color{black!80}
...
\color{black!80}
\hspace{0.6cm} 
$X'(M)=X(i), \hspace{0.3cm} \bar{z}'(M)=\bar{z}(i)$
...
\color{black!60!blue!80}DO
 ...
 \hspace{1cm}  \color{black!60} ! 速度插值
   \color{black!80}
...
\color{black!80}
\hspace{0.6cm} 
$X'(ip)=X_p(i), \hspace{0.3cm} \bar{z}'(ip)=\bar{z}_p(i)$
...
\hspace{0.6cm} $Lx=-u(i)\Delta t/\Delta x$

\hspace{0.6cm} $M=i+\text{floor}(Lx+0.5)$

\hspace{0.6cm} $X'(i)=0$

\hspace{0.6cm} $\hat{z}'(i)=\hat{z}(M)$
