...
\hspace{2cm}\color{black!60!red!80!}一维双信息保存方法（DIP）伪代码
...
\scriptsize
 ...
 L_x=X(i)+\bar{u}(i)\Delta t/ \Delta x,
  ...
  \hspace{0.3cm}
  $X(i)=L_x-\text{floor}(L_x+0.5)$

 \hspace{0.3cm}
 $M(i)=i+\text{floor}(L_x+0.5)$
...
\color{black!60!blue!80}DO
 \color{black!80} $i=0,Np$
   ...
   \hspace{0.3cm} $s_x=\text{sign}(X_p(i))$
