...
\hspace{0.13cm} \color{black!80} $N_p=(Nx+1)*(Ny+1)$  
...
\hspace{0.7cm}\color{black!60!blue!80}DO
 \color{black!80} $n=0,Np$
\vspace{0.1cm}

\hspace{1.5cm} $s_x=\text{sign}(X_p(n)), s_y=\text{sign}(Y_p(n))$

 \hspace{1.5cm}	$
  \begin{array}{l}
	\bar{u}_p(n)=(1-|X_p|)u(ip,jp)+|X_p|u(ip+s_x,jp)\\
	\bar{v}_p(n)=(1-|Y_p|)v(ip,jp)+|Y_p|v(ip,jp+s_y)\\
	\end{array}
$
 \hspace{0.5cm}
 ...
 \hspace{1.5cm}	$
  \begin{array}{l}
	L_x=X_p(n)+\bar{u}_p(n)\Delta t/ \Delta x\\
	L_y=Y_p(n)+\bar{v}_p(n)\Delta t/ \Delta y\\
	\end{array}
	$
...
\color{black!80} $\bar{z}_p(n)<\bar{z}'(ip,jp)$  
\color{black!60!blue!80}THEN
...
\fbox{
\hspace{1.3cm} 
$\begin{array}{l} X'(ip,jp)=[X_p(n)+\text{Mrk}_p(ip,jp)X'(ip,jp)]/[\text{Mrk}_p(ip,jp)+1]\\
Y'(ip,jp)=[Y_p(n)+\text{Mrk}_p(ip,jp)Y'(ip,jp)]/[\text{Mrk}_p(ip,jp)+1]\\
\bar{z}'(ip,jp)=[\bar{z}_p(n)+\text{Mrk}_p(ip,jp)\bar{z}'(ip,jp)]/[\text{Mrk}_p(ip,jp)+1]
\end{array}$
