...
\end{tikzpicture}
\caption{\bf 单元单元点生成方法，多个单元点，无厚度界面情况}
 \addtocounter{figure}{-1}
\vspace{1.5pt}
%\SetEnglishCaption
\renewcommand{\figurename}{Figure}
 \caption{\bf 1D sketch of the construction of cell-point, the cell with more than one cell-points, the tranditional interface case}
