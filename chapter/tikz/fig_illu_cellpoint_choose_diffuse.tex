...
\draw  [->,line width=1pt,color=black!60](0,0)--(6.5,0) node [anchor=north] {$x$};
 ...
 \draw[->,line width=5pt,color=black!60] (6.5,3)--(7.5,3);
\end{tikzpicture}
  \begin{tikzpicture}[domain=1:5]
	\node (A1) [circle,draw,inner sep=0.5mm]  at (0.5,0){}; 
	%\node (A2) [circle,draw,inner sep=0.5mm]  at (1,0){}; 
...
\draw  [->,line width=1pt,color=black!60](0,0)--(6.5,0) node [anchor=north] {$x$};
 ...
 %\draw[line width=1.5pt,color=black!80, dashed](2.9,0)--(2.9,3.5);
\end{tikzpicture}
\caption{\bf 单元点生成方法，多个单元点，耗散界面情况}
 \addtocounter{figure}{-1}
\vspace{1.5pt}
%\SetEnglishCaption
\renewcommand{\figurename}{Figure}
 \caption{\bf 1D sketch of the construction of cell-point, the cell with more than one cell-points, the diffusive interface case}
